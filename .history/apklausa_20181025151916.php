...
if (!empty($_POST)){
    ...
    if (!empty($_POST)) {
        $sql = "INSERT INTO users (user_ip, name, content, phoneatm, phonechange, age, favbrand, gender, whychange)
        VALUES('$ip', '$name', '$content', '$phoneatm', '$phonechange', '$city', '$password', '$gender', '$imagetmp', '$imagename')";     
       } else {
