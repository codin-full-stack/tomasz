            ...
            <div class="feed-box">
                <div class="feed-box-image-container">
                    <?php if (!empty($post['image'])){ ?>
                        <a href="post.php?ID=<?php echo $post['post_id']; ?></a>   <img src="data:image/jpeg;base64,<?php echo base64_encode($post['image']); ?>" class="feed-box-image" />
                ...
                <div class="feed-box-title"> 
                    ...
                    <a href="post.php?ID=<?php echo $post['post_id']; ?>">Read more
                        <?php
                                // echo $row['title'];
