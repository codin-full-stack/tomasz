...
if (!empty($_POST)) {
    if ($_POST['pass'] != $_POST['passconf']) {
        ...
        $result= mysqli_query($conn, $usql);
            ...
            $_POST['pass'] = md5($_POST['pass']);
            $usql = "UPDATE users SET name ='".$_POST['vrd']."', surename = '" . $_POST['pvd'] . "', email = '" . $_POST['email'] . "', city = '" . $_POST['city'] . "', age = '" . $_POST['amz'] . "', password = '" . $_POST['pass'] . "', gender = '" . $_POST['lyt'] . me . "' where id = '" . $data['id']. "'";
            $result= mysqli_query($conn, $usql);
        }   
    }
}
