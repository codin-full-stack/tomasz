...
<body>
    <div class="container">
        ...
        <div class="buttons">
            <button type="button" onclick="window.location.href='http://localhost:8081/tomasz/login.php'" class="lButton" required><b>Login</b></button>
        ...
        <div class="boxReg">
            ...
            <div class="box-bottom">
                <button name="reg" type="sumbit" class="sigin">
                    Register
                </button>
            </div>
        </div>
