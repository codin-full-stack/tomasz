...
// var all = document.querySelectorAll(".feed-box-heading");

var all = document.querySelectorAll('.feed-box-heading').forEach(function(node) {
    all.innerHTML = "iki kaledu liko: " + days;
});