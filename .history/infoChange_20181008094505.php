...
if (!empty($_POST)) {
    if ($_POST['pass'] != $_POST['passconf']) {
        ...
        $usql = "UPDATE users SET name ='".$_POST['vrd']."', surename = '" . $_POST['pvd'] . "', email = '" . $_POST['email'] . "', city = '" . $_POST['city'] . "', age = '" . $_POST['amz'] . "', password = '" . $_POST['pass'] . "', gender = '" . $_POST['lyt'] . "',image = '" . $imagetmp . "',image = '" . $imagetmp . "' where id = '" . $data['id']. "'";
