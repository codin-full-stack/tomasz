    ...
    <section class="second">
      <div class="container-fluid flex">  
        <div class="textbox2">
          ...
          <h2 class="secondtext2">This theme features is flexible, UX friendly sidebar menu and stock photos from your friends at <font color="#1d809f">Unsplash!</font></i></h2>
