    ...
    <section class="second">
      <div class="container-fluid flex">  
        <div class="textbox2">
          ...
          <h2 class="secondtext2"><i>This theme features is flexible, UX friendly sidebar menu and stock photos from your friends at <h2 class="blue">Unsplash!</style></i></h2>
