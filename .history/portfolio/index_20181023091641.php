    ...
    <section class="second">
      <div class="container-fluid flex">  
        <div class="textbox2">
          ...
          <h2 class="secondtext2"><i>This theme features is flexible, UX friendly sidebar menu and stock photos from your friends at Unsplash!</i></h2>
          ...
          <div class="row">
              <div class="col-md-6">
                <img src="images/portfolio-1.jpg" alt="">
                  <div class="photobox">
                  <h2 class="maintext6">STATIONARY</p>
              ...
              <img src="images/portfolio-2.jpg" alt="">
                <div class="photobox">
                  <p class="maintext6">ICE CREAM</p>
                  <p class="secondtext6">A dark blue background with a colored pencil, a clip, and a tiny ice cream cone!</p>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <img src="images/portfolio-3.jpg" alt="">
                <div class="photobox">
                  <p class="maintext6">STRAWBERRIES</p>
                  <p class="secondtext6">Strawberries are such a tasty snack, especially with a little sugar on top!</p>
                </div>  
              </div>
              <div class="col-md-6">
                <img src="images/portfolio-4.jpg" alt="">
                  <div class="photobox">
                    <p class="maintext6">WORKSPACE</p>
                    <p class="secondtext6">A yellow workspace with scissors, pencils, and other objects</p>
                </div>  
              </div>
            </div>
        </div>
