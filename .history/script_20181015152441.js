...
ContentScriptGlobalScope.l
// forchange = document.getElementsByid("colors").addEventListener('change', changecolor);

// function changecolor(){
//   set = document.getElementById("body")
//   set.style.backgroundColor = "this.value";
