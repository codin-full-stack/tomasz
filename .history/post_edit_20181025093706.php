...
<div class="textPad">
    <form action="" method="POST">
        <input type="text" name="titlee" value="<?php echo (! empty($row['title']) ? $row['title'] : ''); ?>">
        <textarea name="contentt" id="content" rows="20" cols="48" value="" ><?php echo (! empty($row['content']) ? $row['content'] : ''); ?></textarea>
