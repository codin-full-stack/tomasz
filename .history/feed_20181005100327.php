    ...
    <div class="feed-box">
        <div class="feed-box-image-container">
            <?php if (!empty($row['image'])){
                    echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['image'] )."class='feed-box-image' alt=\"\"  />";
                }
            ?>
        </div>
        <div class="feed-box-title"> 
            <h2 class="feed-box-heading">
                <?php   $row["title"];
                        ...
                        // echo $row['title'];
                        echo $str . . "<a href='post.php?ID={$row['post_id']}'>Read more</a>&nbsp&nbsp<br><br><br>";   
