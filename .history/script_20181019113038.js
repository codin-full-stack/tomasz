...
var calc = document.getElementsByClassName("calc-number1, calc-number-2, calc-number3").addEventListener('click', writeit);

function writeit() {
  document.getElementsByClassName("calc-input-box").innerHTML = this.value;
}