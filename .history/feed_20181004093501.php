...
<div class="feed-box">
     ...
     <div class="feed-box">
        ...
        <div class="feed-box-title"> 
            <h2 class="feed-box-heading">
            Ipsum non incidunt animi perspiciatis. Dolores, error ad veniam esse eos possimus corrupti ex sapiente perferendis reiciendis non temporibus dicta, voluptatem quas!
            </h2>
        </div>
    </div>    
